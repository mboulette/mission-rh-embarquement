	...
	<div class="container">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h1>Talents <small>Modifiers les talents disponibles</small></h1>
			</div>

				<div class="panel-body">

					<form action="/inscriptions/admin/feats/edit" method="post">
						<input type="hidden" name="submitaction" value="edit">
						<input type="hidden" name="id" value="new">

						<button type="submit" class="btn btn-warning">
							<i class="fa fa-plus-circle fa-2x"></i>
							<div>Nouveau Talent</div>
						</button>
					</form>
							...
							<tbody>
								...
								<tr class='action'>
									<th>
										...
										<button class="delete btn btn-danger btn-xs" data-url="/inscriptions/admin/feats/erase" data-id='<?php echo $current['id']; ?>' data-toggle="tooltip" title="Supprimer"><i class='fa fa-trash'></i></button>
									</th>
									<?php foreach ($columns as $column_name => $field_name) { ?>
...
<form id="form-edit" action="/inscriptions/admin/feats/edit" method="post" class="hidden">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<p>Êtes-vous certain de vouloir supprimer ce talent ?</p>
