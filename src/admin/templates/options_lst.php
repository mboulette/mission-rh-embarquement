							...
							<tbody>
								...
								<tr class='action'>
									<th>
										...
										<button class="lock btn btn-warning btn-xs <?php if ($current['locked'] == 0) echo 'hidden'; ?>" data-url="/inscriptions/admin/options/lock" data-id='<?php echo $current['id']; ?>' data-toggle="tooltip" title="Activer"><i class='fa fa-unlock'></i></button>
										<button class="lock btn btn-warning btn-xs <?php if ($current['locked'] == 1) echo 'hidden'; ?>" data-url="/inscriptions/admin/options/lock" data-id='<?php echo $current['id']; ?>' data-toggle="tooltip" title="Désactiver"><i class='fa fa-lock'></i></button>
