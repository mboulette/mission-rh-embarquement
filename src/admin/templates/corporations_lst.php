	...
	<div class="container">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h1>Corporations <small>Modifiers les corporations disponibles</small></h1>
			</div>

				<div class="panel-body">

					<form action="/inscriptions/admin/corporations/edit" method="post">
...
<form id="form-edit" action="/inscriptions/admin/corporations/edit" method="post" class="hidden">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<p>Êtes-vous certain de vouloir supprimer cette corporation ?</p>
