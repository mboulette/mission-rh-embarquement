	...
	<div class="container">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h1>Recettes <small>Modifiers les recettes disponibles</small></h1>
			</div>

				<div class="panel-body">

					<form action="/inscriptions/admin/recipes/edit" method="post">
							...
							<tbody>
								...
								<tr class='action'>
									<th>
										...
										<button class="delete btn btn-danger btn-xs" data-url="/inscriptions/admin/recipes/erase" data-id='<?php echo $current['id']; ?>' data-toggle="tooltip" title="Supprimer"><i class='fa fa-trash'></i></button>
									</th>
									<?php foreach ($columns as $column_name => $field_name) { ?>
...
<form id="form-edit" action="/inscriptions/admin/recipes/edit" method="post" class="hidden">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<p>Êtes-vous certain de vouloir supprimer cette recette ?</p>
