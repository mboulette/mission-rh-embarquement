		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-horizontal">
					...
					<div class="hidden-xs">
						<a href="/inscriptions/admin/players" class="btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp;Retour à la liste</a>
					...
					<div class="row visible-xs-block">
						<div class="col-sm-5 text-center">
							<img src="<?php echo $player['picture_url']; ?>" class="img-circle img-thumbnail" width="140">
						</div>
					</div>

					<div class="row">
						<div class="col-sm-2 hidden-xs"><img src="<?php echo $player['picture_url']; ?>" class="img-thumbnail" width="140"></div>
						<div class="col-sm-8">

							<h3 style="margin-top:5px;"><?php echo $player['firstname']; ?> <?php echo $player['lastname']; ?></h3>
							<table>
						...
						<div class="col-sm-2">
							...
							<div><?php echo substr($player['date_created'], 0, 10); ?></div>

							<div>&nbsp;</div>
							<strong>Modifié le</strong>
							<div><?php echo substr($player['date_updated'], 0, 10); ?></div>
				...
				<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
					...
					<div class="row">
						...
						<div class="col-sm-10">
							<div class="row">
								...
								<div class="col-sm-9 form-control-static"><?php echo $player['firstname']; ?></div>
							</div>

							<div class="row">
								<label class="col-sm-3 control-label">Nom de famille</label>
								<div class="col-sm-9 form-control-static"><?php echo $player['lastname']; ?></div>
							</div>
					...
					<div class="row">
						...
						<div class="col-sm-9 form-control-static"><img src="<?php echo $player['picture_url']; ?>" class="img-thumbnail" width="140"></div>
					</div>
