	...
	<div class="container">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h1>Professions <small>Modifiers les professions disponibles</small></h1>
			</div>

				<div class="panel-body">

					<form action="/inscriptions/admin/professions/edit" method="post">
						<input type="hidden" name="submitaction" value="edit">
						<input type="hidden" name="id" value="new">

						<button type="submit" class="btn btn-primary">
							<i class="fa fa-plus-circle fa-2x"></i>
							<div>Nouvelle Profession</div>
						</button>
					</form>
							...
							<tbody>
								...
								<tr class='action'>
									<th>
										...
										<button class="delete btn btn-danger btn-xs" data-url="/inscriptions/admin/professions/erase" data-id='<?php echo $current['id']; ?>' data-toggle="tooltip" title="Supprimer"><i class='fa fa-trash'></i></button>
									</th>
									<td>
...
<form id="form-edit" action="/inscriptions/admin/professions/edit" method="post" class="hidden">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<p>Êtes-vous certain de vouloir supprimer cette profession ?</p>
