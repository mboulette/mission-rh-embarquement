<?php if (!empty($files)) { ?>
	<table class="table table-striped table-hover">
		...
		<tbody>
			...
			<tr class='action'>
				<td>
					<button class="list-action btn btn-primary btn-xs" data-form="form-auto" data-id="0" data-action="<?php echo $file['path']; ?>" data-toggle="tooltip" title="Télécharger"><i class='fa fa-download'></i></button>
